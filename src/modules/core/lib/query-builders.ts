...
import { BaseModel, ModelIncludeOptions, QueryFilter } from '@/modules/core/types';
...
export function buildIncludeOptions(includeOptions?: BankAccountIncludeOptions):string
export function buildIncludeOptions(includeOptions?: BankConnectionIncludeOptions):string
export function buildIncludeOptions(includeOptions?: BankTransactionIncludeOptions):string
export function buildIncludeOptions<
  TModel extends BaseModel
>(includeOptions?: ModelIncludeOptions<TModel>): string{
